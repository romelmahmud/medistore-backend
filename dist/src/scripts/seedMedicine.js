...
function getMedicineImage(name) {
    ...
    return `https://dummyimage.com/400x400/edf2f7/1a202c&text=${encodeURIComponent(safeName)}`;
}
// Seed function
    ...
    try {
        for (const categoryName of categories) {
            ...
            for (const med of meds) {
                ...
                await prisma_1.prisma.medicine.upsert({
...
seedMedicines();
//# sourceMappingURL=seedMedicine.js.map